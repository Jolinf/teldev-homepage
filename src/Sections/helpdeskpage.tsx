import { Headset, PhoneCall, Wrench, Mail, ListChecks } from 'lucide-react';
...
export default function HelpdeskPage() {
  return (
    <ServicePageLayout
      ...
      intro={[
        "Technology should make your day easier, not harder. When a laptop won't wake up, an inbox stops syncing, or a login just refuses to work, momentum stalls. That's exactly the moment our Helpdesk Support is built for.",
