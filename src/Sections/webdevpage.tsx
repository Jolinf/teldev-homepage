      ...
      <div className="max-w-5xl mx-auto mt-40">
        ...
        <div className="mb-12">
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-[#FAFAFA] leading-relaxed mb-4">
            n the digital world, your website or app is more than just a presence—it’s often your
        ...
        <div id="Custom Application Development" className="mb-12">
          <h3
        ...
        <div id="Website Design and Development" className="mb-12">
          <h3
            className="text-2xl sm:text-3xl font-semibold mb-4"
            style={{ fontFamily: 'Poppins, sans-serif' }}
          >
        ...
        <div id="Performance monitoring and optimization" className="mb-12">
          <h3
            className="text-2xl sm:text-3xl font-semibold mb-4"
            style={{ fontFamily: 'Poppins, sans-serif' }}
          >
        ...
        <div id="CMS support" className="mb-12">
          <h3
            className="text-2xl sm:text-3xl font-semibold mb-4"
            style={{ fontFamily: 'Poppins, sans-serif' }}
          >
