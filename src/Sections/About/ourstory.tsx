...
const OurStory = () => {
  ...
  const paragraphs = [
    `There's a common misconception among small business owners: that good technology is a luxury reserved for large corporations with deep pockets and entire IT departments.`,
  ...
  return (
    <motion.section
      className="box-border bg-[#0A0A0A] flex justify-left text-left text-[#FFFFFF] px-4 sm:px-8 md:px-12 py-20 relative overflow-hidden"
      initial="hidden"
      whileInView="visible"
